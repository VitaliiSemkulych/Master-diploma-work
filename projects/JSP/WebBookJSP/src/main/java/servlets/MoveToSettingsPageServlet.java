 ...
 * @author Admin
 */
// servlet  process functionality which load page where user con update data about yourself
@WebServlet(name = "MoveToSettingsPageServlet", urlPatterns = {"/MoveToSettingsPageServlet"})
public class MoveToSettingsPageServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     request.getSession().setAttribute("userPage", null);
        ...
        response.sendRedirect(request.getContextPath() + "/MainPagies/settings.jsp");
    }
